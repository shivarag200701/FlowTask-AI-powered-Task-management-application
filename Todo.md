...
- [x] OAuth (some problem with authorization with google cloud)
- [x] Change the layout to have a upcoming page/modal where user can select any day in the future
- [x] Think about plans for calender view
- [ ] Create a Rich text editor for Description
- [ ] Subtasks for a main task
- [x] Implement Overdue section and enable reschedule for them
...
- [x] **Reminders & Notifications** - Browser notifications for due tasks
