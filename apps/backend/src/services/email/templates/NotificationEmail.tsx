...
export function NotificationEmail({ title, todoId }: NotificationProps) {
  const frontendUrl =
        ...
        <Body className="bg-[#f5f5f5] font-sans">
          <Container className="max-w-md">
            ...
            <Container className="bg-white border border-gray-200 rounded-xl p-6 max-w-md ">
              ...
              <Text className="mt-0 mb-6 text-[#284ea7]">Due Now</Text>
              <Hr className="my-[16px] border-gray-200 border-t" />
              <Button
                className="rounded-lg p-3 bg-[#284ea7] text-white text-sm cursor-pointer"
