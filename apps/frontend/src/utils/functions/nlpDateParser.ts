...
//   const weekdayMatch = dayName.match(
//     /(sunday|monday|tuesday|wednesday|thursday|friday|saturday|sun|mon|tue|wed|thu|fri|sat)/i,
//   );
//   const weekdayKey = weekdayMatch
...
// ): { date: Date | null; matchedString?: string } {
...
//     return {
//       date: getNextWeekday(weekdayMatch[1], allowToday),
...
//     return {
//       date: today,
//       matchedString: findMatchedString(originalInput, "today"),
//     };
//   }
//   if (normalized.includes("tdy")) {
//     return {
//       date: today,
//       matchedString: findMatchedString(originalInput, "tdy"),
//     };
//   }
...
//     return {
//       date: tomorrow,
//       matchedString: findMatchedString(originalInput, "tomorrow"),
//     };
//   }
...
//     return {
//       date: tomorrow,
//       matchedString: findMatchedString(originalInput, "tmrw"),
//     };
//   }
...
//     return {
//       date: tomorrow,
//       matchedString: findMatchedString(originalInput, "tmr"),
//     };
//   }
...
//     return {
//       date: dat,
//       matchedString: findMatchedString(originalInput, "day after tomorrow"),
//     };
//   }
...
//     return {
//       date: dat,
//       matchedString: findMatchedString(originalInput, "dat"),
//     };
//   }
...
//     return {
//       date: nextWeek,
//       matchedString: findMatchedString(originalInput, "next week"),
//     };
//   }
...
//     return {
//       date: nextWeek,
//       matchedString: findMatchedString(originalInput, "nxt week"),
//     };
//   }
...
//       matchedString: findMatchedString(originalInput, "weekend"),
//     };
//   }
//   if (normalized.includes("wknd")) {
//     return {
//       date: getNextWeekday("saturday"),
//       matchedString: findMatchedString(originalInput, "wknd"),
//     };
//   }

//   // Next [weekday]
//   const nextDayMatch = normalized.match(
//     /next\s+(sunday|monday|tuesday|wednesday|thursday|friday|saturday|sun|mon|tue|wed|thu|fri|sat)/i,
//   );
//   if (nextDayMatch) {
...
//   // This [weekday]
//   const thisDayMatch = normalized.match(
//     /this\s+(sunday|monday|tuesday|wednesday|thursday|friday|saturday|sun|mon|tue|wed|thu|fri|sat)/i,
//   );
//   if (thisDayMatch) {
...
//     return {
//       date: nextMonth,
//       matchedString: findMatchedString(originalInput, "next month"),
//     };
//   }
...
//     return {
//       date: nextYear,
//       matchedString: findMatchedString(originalInput, "next year"),
//     };
//   }
...
//   const usDateMatch = normalized.match(
//     /^(\d{1,2})[\/\-](\d{1,2})[\/\-](\d{4})$/,
//   );
//   if (usDateMatch) {
...
//     /(every\s+)(\d+\s+)?weeks?|weekly|each\s+week/i,
//   );
//   if (weeklyMatch) {
//     return {
//       isRecurring: true,
...
//   // Every [weekday]
//   const weekdayMatch = normalized.match(
//     /every\s+\b(sunday|monday|tuesday|wednesday|thursday|friday|saturday|sun|mon|tue|wed|thu|fri|sat)\b/i,
//   );
//   if (weekdayMatch) {
...
//     /(every\s+)?(\d+\s+)?months?|monthly|each\s+month/i,
//   );
//   if (monthlyMatch) {
//     return {
//       isRecurring: true,
...
//     /(every\s+)?(\d+\s+)?years?|yearly|annually|each\s+year/i,
//   );
//   if (yearlyMatch) {
//     return {
//       isRecurring: true,
...
//       const relativeResult = parseRelativeDate(
//         dateInput,
...
//   const combinedMatchedString =
//     uniqueMatchedStrings.length > 0
...
//     result.recurrenceEndDate = recurringInfo.endDate
//       ? formatDate(recurringInfo.endDate)
//       : null;
...
//     // Special handling for "every [weekday]" patterns
//     if (
//       recurringInfo.weekdayName &&
//       result.recurrencePattern === "weekly" &&
//       result.recurrenceInterval === 1
//     ) {
//       const weekdayDisplay =
//         recurringInfo.weekdayName.charAt(0).toUpperCase() +
//         recurringInfo.weekdayName.slice(1);
