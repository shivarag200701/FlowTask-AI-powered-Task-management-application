...
const AddTaskCalender = ({
  ...
  useEffect(() => {
    if (todo) {
      setSelectedDate(
        todo?.completeAt
          ? getDateFromDate(todo.completeAt)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(
        todo?.id ? "Error updating todo" : "Error creating todo",
        error,
      );
    } finally {
  ...
  return createPortal(
    <>
      ...
      <form
        ...
        className={`px-4 pt-4 pb-2 bg-task fixed z-50 backdrop-blur-sm border border-border rounded-xl transition-all duration-300 ${isMobile ? "w-100" : width} min-w-0 shadow-2xl ${isVisible ? "translate-y-0 opacity-100" : "translate-y-5 opacity-0"}`}
        style={{
          top: "50px",
          left: "50%",
        ...
        <div className="flex items-center gap-2 mb-4 flex-wrap">
          ...
          <div className="relative">
            ...
            >
              ...
              {
                <span className="whitespace-nowrap max-w-[100px] font-extralight">
                  {selectedDate ? dateLabel : "Date"}
                </span>
              }
              {isRecurring && (
          ...
          <div className="relative">
            ...
            >
              <div className="flex items-center gap-1">
                ...
                />
                <span className="text-foreground text-xs font-extralight">
                  {priority
