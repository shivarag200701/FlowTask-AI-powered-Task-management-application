  ...
  return (
    <>
      <form
        ...
        className={`px-2 py-3 ${backgroundColor} backdrop-blur-sm border border-border-hover rounded-xl bg-transparent ${width} min-w-0 overflow-hidden `}
      >
        {/* Category Tag */}
        {category && (
          <div className="mb-2">
          ...
          <div className="relative">
            ...
            >
              <div className="flex gap-1">
                ...
                {reminder && (
                  <div className="whitespace-nowrap max-w-[100px] text-[12px]">
                    At time of task
                  </div>
                )}
              </div>
