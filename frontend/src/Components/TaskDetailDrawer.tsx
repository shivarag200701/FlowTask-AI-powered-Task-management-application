      ...
      <div className="" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between p-2 gap-1.5 relative">
          ...
          <div className="flex gap-2">
            <button
              className={`text-muted-foreground p-2 rounded-md  transition-colors cursor-pointer disabled:cursor-not-allowed ${isAtTop ? "opacity-10 hover:none" : "hover:bg-muted"}`}
            ...
            <button
              className={`text-muted-foreground p-2 rounded-md hover:bg-muted transition-colors cursor-pointer ${isAtBottom ? "opacity-10 hover:none" : "hover:bg-muted"}`}
              onClick={handleAfter}
              disabled={isAtBottom}
            >
              <Tooltip>
        ...
        <div className=" grid max-md:overflow-auto md:grid-cols-[2fr_1fr] gap-y-6 ">
          ...
          <div className="scrollbar-hide px-6 md:overflow-auto md:pl-0 md:pr-4">
            <div
              className={`text-white  ${isEditing ? "opacity-50" : "opacity-100"} w-full p-4 px-5 relative`}
            >
              <div className="absolute inset-0 rounded-xl border border-neutral-200 bg-neutral-50 mask-[linear-gradient(180deg,black,transparent)]" />
              <div className="flex flex-col">
                <div className="flex flex-col gap-2">
                  ...
                  <button
                    className={`flex justify-between gap-2 p-1 px-2  ${!isEditing && "dark:hover:bg-accent/30 hover:bg-accent/10"} rounded-sm duration-300 transition-all group ${isEditing ? "cursor-not-allowed" : "cursor-pointer"} `}
                  >
                    <div className="flex gap-2">
                      <div className="flex items-center justify-center">
                        ...
                        >
                          <div className="flex justify-between">
                            <div className="flex gap-2 items-center justify-center">
                              <Calendar
                                size={15}
                                className={`${true ? "text-green-500" : "text-white"}`}
                              />
                              <div className="flex gap-3">
                                {dateLabel && (
                                  <span className="whitespace-nowrap max-w-[100px] text-muted-foreground text-[12px] font-light">
                                    {dateLabel}
                                  </span>
                                )}
                      ...
                      <TooltipContent>
                        <div className="text-white gap-2">
                          <p className="text-[12px]">
                            {convertDateTime(selectedDate, selectedTime)}
                          </p>
                  ...
                  <button
                    className={`flex justify-between gap-2 p-1 px-2 ${!isEditing && "dark:hover:bg-accent/30 hover:bg-accent/10"}
                  ...
                  >
                    <div className="flex gap-2">
                      <div className="flex items-center justify-center">
                        <Flag
                          size={15}
                          className={`${priority ? priorityColors[priority] : "text-gray-500"}`}
                          style={{
                            fill:
                              priority === "high"
                                ? "#DC2828"
                    ...
                    <div className="flex items-center justify-center">
                      <ChevronDown
                        className={`${!isEditing && "group-hover:opacity-100"} opacity-0 ${showPriorityPicker ? "opacity-100" : ""}`}
                        size={15}
                      />
                    </div>
                  </button>
