    ...
    <>
      <div className="relative w-full flex">
        <SideBar expanded={expanded} setExpanded={setExpanded}>
          {expanded && (
            <button
              className="relative flex gap-2 mb-5 py-3 rounded-lg bg-accent text-center text-white cursor-pointer w-full group shadow-sm hover:shadow-lg hover:opacity-95 transition-opacity"
              onClick={() => openModal()}
            >
