  ...
  return(
    <div className="w-full max-w-xl grow relative z-10">
      <motion.div
        ...
        className="flex flex-col items-center text-center gap-1 sm:rounded-[28px] sm:border sm:border-border bg-card/80 backdrop-blur-2xl p-8 sm:p-10 sm:shadow-lg" >
  ...
  return (
    <>
      <div className="min-h-screen flex flex-col items-center justify-center ">
          ...
          <button onClick={() => {navigate('/')}} className="text-slate-600  hidden lg:block hover:text-slate-900  absolute z-10 top-10 left-10 gap-2 px-4 py-3 rounded-xl border border-slate-200/50 hover:border-slate-300/50 shadow-sm backdrop-blur-2xl cursor-pointer bg-white/10 hover:bg-white hover:shadow-md">
