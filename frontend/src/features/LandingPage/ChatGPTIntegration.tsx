...
import PathAnimation from "@/features/_legacy/PathAnimation";
...
const ChatGPTIntegration = () => {
  ...
  return (
    ...
    <>
      ...
      <div
        className="relative flex flex-col scale-[0.8] xl:scale-100 lg:flex-row items-center justify-center gap-8 lg:gap-16 w-full xl:mb-5 xl:mt-3"
        ref={containerRef}
      >
        <div className="absolute inset-0 pointer-events-none z-0">
          <PathAnimation
            containerRef={containerRef}
            featureRefs={[div1Ref, div2Ref, div3Ref, div5Ref, div6Ref]}
            centerRef={div4Ref}
          />
        </div>
      ...
      <div className="flex flex-col items-start justify-center gap-2 text-center">
        ...
        <p className="text-[16px] text-accent max-w-xl text-start font-medium">
          ChatGPT helps break down your tasks and schedule them smartly, so you
          can focus on doing.
        </p>
      </div>
    </>
