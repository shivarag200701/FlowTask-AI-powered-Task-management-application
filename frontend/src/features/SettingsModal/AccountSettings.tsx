  ...
  return (
    <div className="bg-background h-full rounded-r-md font-medium flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar">
        ...
        {isPending ? (
          <div className="flex justify-center items-start min-h-[calc(100vh-100px)] pt-10 gap-4">
          ...
          <div>
            <div className="p-4">
              ...
              <div className="flex">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[12px] text-white/70 mt-2">
                    Pick a photo up to 4MB.
                  </span>
                  <span className="text-[12px] text-white/70 mt-1 ">
                    Your avatar would be public.
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="p-4">
              <div className="flex flex-col gap-2">
                ...
                <button
                  ...
                  onClick={() => handleNavigateWithUnsavedCheck("email")}
                >
                  Change email
                </button>
              </div>
            ...
            <div className="p-4">
              <div className="flex flex-col gap-2">
                ...
                <span className="font-extralight text-[12px] text-foreground">
                  Log in to FlowTask with your Google, Facebook, or Apple
